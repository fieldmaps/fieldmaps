...
export default () => {
  return (
    <>
      <h1 className="has-text-centered">Population Statistics</h1>
      ...
      <h2>
        UN World Population Prospects, {new Date().getFullYear()} Projection
      </h2>
      <p>
      ...
      <p>
        ...
        to create a complete global coverage population raster. Results are
        aggregated to{' '}
        <a href="https://data.fieldmaps.io/edge-matched/humanitarian/intl/adm4_polygons.gpkg.zip">
          humanitarian edge-matched boundaries
        </a>
        , adjusted so that ADM0 totals match those of the 2022 projections in
        the{' '}
        <a href="https://population.un.org/wpp/Download/Standard/CSV/">
          United Nations World Population Prospects
        </a>
        . See{' '}
        <a href="https://github.com/fieldmaps/population-statistics">GitHub</a>{' '}
        for technical information on how this layer is made.
      </p>
      <p>
      ...
      <div className="table-container">
        <table className="table">
          ...
          <tbody>
            ...
            <tr>
              <td>f_15_49</td>
              <td>women of reproductive age (15-49)</td>
            </tr>
          </tbody>
        </table>
      </div>
      <p>
        ...
        adjusting source totals to match UN World Population Prospects,{' '}
